...
public class Main {
    public static void main(String[] args){
        ...
        MediumI d1 = new DVD("tt-150-250", "SpiderMan ", 8.5, FSKRaiting.FSK12, MovieGenre.CRIME);
        MediumI d2 = new DVD("tt-579-232", "NoPain", 4.5, FSKRaiting.FSK12, MovieGenre.COMEDY);
        MediumI d3 = new DVD("tt-971-520", "TheRide", 2.5, FSKRaiting.FSK12, MovieGenre.COMEDY);


        MediumI c1 = new CD("657950", "Lalo", "Lila", 2.70, true, MusicGenre.CLASSIC);
        MediumI c2 = new CD("651278","Timoa", "Wizz", 3.78, false, MusicGenre.BLUES);

        MediumI b1 = new BluRay("nm-652-741", "BatMan", 10.0, FSKRaiting.FSK12, MovieGenre.ADVENTURE);
        MediumI b2 = new BluRay("nm-520-650", "TheLion", 5.45, FSKRaiting.FSK0, MovieGenre.COMEDY);
                ...
                if (rent.equalsIgnoreCase("DVD") || rent.equalsIgnoreCase("BLURAY")) {
                    ...
                    if (itemName.equalsIgnoreCase("SPIDERMAN")) {
                        if (money < d1.getPrice()) {
                            System.out.println("Sorry You cant rent this, you dont have enough credit! See You later");
                            break;
                        }else if (!d1.canBeRentedByAge(customer.getAge())){
                            System.out.println("Sorry you cant rent this item because of your Age!");
                        }
                        customer.rent(d1);
                        money -= d1.getPrice();
                        ...
                        if (money < d2.getPrice()) {
                            System.out.println("Sorry You cant rent this, you dont have enough credit! See You later");
                            break;
                        }else if (!d2.canBeRentedByAge(customer.getAge())){
                            System.out.println("Sorry you cant rent this item because of your Age!");
                        }
                        customer.rent(d2);
                        money -= d2.getPrice();
                        ...
                        if (money < d3.getPrice()) {
                            System.out.println("Sorry You cant rent this, you dont have enough credit! See You later");
                            break;
                        }else if (!d3.canBeRentedByAge(customer.getAge())){
                            System.out.println("Sorry you cant rent this item because of your Age!");
                        }
                        customer.rent(d3);
                        money -= d3.getPrice();
                        ...
                        if (money < b1.getPrice()) {
                            System.out.println("Sorry You cant rent this, you dont have enough credit! See You later");
                            break;
                        }else if (!b1.canBeRentedByAge(customer.getAge())){
                            System.out.println("Sorry you cant rent this item because of your Age!");
                        }
                        customer.rent(b1);
                        money -= b1.getPrice();
                        ...
                        if (money < b2.getPrice()) {
                            System.out.println("Sorry You cant rent this, you dont have enough credit! See You later");
                            break;
                        }else if (!b2.canBeRentedByAge(customer.getAge())){
                            System.out.println("Sorry you cant rent this item because of your Age!");
                        }
                        customer.rent(b2);
                        money -= b2.getPrice();
                    ...
                    if (cdID == 657950) {
                        if (money < c1.getPrice()) {
                            System.out.println("Sorry You cant rent this, you dont have enough credit! See You later");
                            break;
                        }else if (!c1.isExplicit() && customer.getAge() < 18){
                            System.out.println("Sorry you cant rent this item because of your Age!");
                        }
                        customer.rent(c1);
                        money -= c1.getPrice();
                        ...
                        if (money < c2.getPrice()) {
                            System.out.println("Sorry You cant rent this, you dont have enough credit! See You later");
                            break;
                        }else if (!c2.isExplicit() && customer.getAge() < 18){
                            System.out.println("Sorry you cant rent this item because of your Age!");
                        }
                        customer.rent(c2);
                        money -= c2.getPrice();
